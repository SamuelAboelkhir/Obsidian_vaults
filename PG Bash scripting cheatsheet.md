...
- [Bash Hackers Wiki](https://web.archive.org/web/20230406205817/https://wiki.bash-hackers.org/) *(wiki.bash-hackers.org)*
...
See: [Functions](https://devhints.io/#functions)
...
See: [Conditionals](https://devhints.io/#conditionals)
