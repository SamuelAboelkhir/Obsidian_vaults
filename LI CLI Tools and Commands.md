...
```
- [[LI xargs|xargs]]: Reads items from standard input and executes commands with those items as arguments.
- [[LI Awk Command Cheat Sheet & Quick Reference|awk]]
- [[LI Sed Command Cheat Sheet & Quick Reference|sed]]
...
### Services
1. [[LI CLI Tools and Commands#^484cec|service such as webservers]]
