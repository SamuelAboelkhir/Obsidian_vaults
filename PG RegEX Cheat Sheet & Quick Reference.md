...
- [Regex in Python](https://quickref.me/#regex-in-python) *(quickref.me)*
- [Regex in JavaScript](https://quickref.me/#regex-in-javascript) *(quickref.me)*
- [Regex in PHP](https://quickref.me/#regex-in-php) *(quickref.me)*
- [Regex in Java](https://quickref.me/#regex-in-java) *(quickref.me)*
- [Regex in MySQL](https://quickref.me/#regex-in-mysql) *(quickref.me)*
- [Regex in Vim](https://quickref.me/vim#search-and-replace) *(quickref.me)*
- [Regex in Emacs](https://quickref.me/emacs#search) *(quickref.me)*
- [Online regex tester](https://regex101.com/) *(regex101.com)*
...
| Pattern | Matches |
| --- | --- |
| `ring        ` | Match ring sp ring board etc. |
| `.           ` | Match a, 9, + etc. |
...
| `id\|identity ` | Match id or id entity |
...
| `r[iau]ng` | Match ring, w rang le, sp rung, etc. |
...
| `(?>id\\|identity)\b` | Match id, but not id entity |
...
| `\b\w+?(?=ing\b)` | Match warbl ing, str ing, fish ing,... |
| `\b(?!\w+ing\b)\w+\b` | Words NOT ending in "ing" |
| `(?<=\bpre).*?\b ` | Match pre tend, pre sent, pre fix,... |
