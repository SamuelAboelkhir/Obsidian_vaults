...
[Desktop Entry]
Name=Doom Emacs
Exec=/usr/bin/emacs --init-directory /home/blackdovah/.config/emacs %F
Terminal=false
Type=Application
Icon=emacs
Comment=Doom Emacs
...
[Desktop Entry]
Name=DoomEmacs
Exec=/home/blackdovah/.config/emacs/bin/doom-emacs --daemon=doom
Terminal=false
Type=Application
Icon=emacs
Comment=Doom Emacs
...
- This is different from systemd services that can start launchs processes as services when the user system starts [[TECH VM firewall rules service]]